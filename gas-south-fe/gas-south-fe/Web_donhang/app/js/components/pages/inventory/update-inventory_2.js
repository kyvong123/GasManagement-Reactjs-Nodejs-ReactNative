                                    ...
                                    <div className="row">
                                        <div className="col-md-6 ">
                                            <Card title="Thông tin kho" bordered={false} headStyle={{ fontWeight: 'bold' }} >
                                                ...
                                                <div className="form-group row">
                                                    <label htmlFor="input_station" className="col-sm-4 col-form-label">Địa chỉ <label style={{ visibility: 'hidden' }}>*</label></label>
                                                    <div className="col-sm-8">
                                                        <Input
                                                            type="text"
                                                            name="address"
                                        ...
                                        <div className="col-md-6 ">
                                            <Card title="Thông tin liên hệ" bordered={false} headStyle={{ fontWeight: 'bold' }}>
                                                ...
                                                <div className="form-group row">
                                                    <label htmlFor="input_note" className="col-sm-4 col-form-label">Ghi chú</label>
                                                    <div className="col-sm-8">
                                                        <Input.TextArea
                                                            name="note"
