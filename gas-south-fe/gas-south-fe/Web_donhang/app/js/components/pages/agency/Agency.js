...
class Agency extends React.Component {
  ...
  async getAllUser() {
    //const jobMetaData = await this.getJobMetaData();
    let user_cookies = await getUserCookies();
    const dataUsers = await getListCustomerByType(user_cookies.user.id, "Agency");
    if (dataUsers) {
        ...
        <div className="card">
          <div className="card-title">
            <div className="flexbox">
              <h4>{this.state.user_type === "General" ? "Đại lý" : "Hệ Thống Đại lý"}</h4>
              <div className="row">
                <button
                  // onClick={() =>
                ...
                >
                  {this.state.user_type === "General" ? "Tạo Đại lý" : "Tạo Hệ Thống Đại lý"}
                </button>
