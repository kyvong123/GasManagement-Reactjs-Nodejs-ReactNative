...
import getAllPersonnel from "../../../../api/getAllPersonnel";
...
class Personnel extends React.Component {
  ...
  async componentDidMount() {
    ...
    const listStation = await getAllPersonnel(user_cookies.user.id);
    this.setState({
  ...
  async submit(event) {
    ...
    if (user_cookies) {
      const params = {
        ...
        "email": data.email,
        "address": user_cookies.user.address,
        "LAT": user_cookies.user.LAT,
        "LNG": user_cookies.user.LNG,
        "userType": "Personnel",
        "userRole": "SuperAdmin",
        "createdBy": user_cookies.user.id,
        "isChildOf": user_cookies.user.id,
        "personRole": this.state.roleSelected
      };
      ...
      await axios.post(
        ...
        .catch(function (err) {
          if (err.response.data.message == "Email in use") {
            showToast("Trùng email hoặc tên rồi !");
          } else {
    ...
    return (
      <div className="main-content">
            ...
            <div className="flexbox">
              ...
              <div className="row">
                <button
                  ...
                  data-toggle="modal"
                  data-target="#create-user-person"
                >
                  Tạo nhân sự
                </button>
        ...
        {<AddUserPopupContainer
          ...
          isPersonnelPage={true}
        //   refresh={this.refresh.bind(this)}
        />}

        <div className="modal fade" id="create-user-person" tabIndex="-1" >
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="form-group">
                          ...
                          >
                            <Select.Option value="create" label="Tạo mới">
                              Tạo mới
                            </Select.Option>
                            <Select.Option value="edit" label="Chỉnh sửa">
                              Chỉnh sửa
                            </Select.Option>
                            <Select.Option value="remove" label="Xoá">
                              Xoá
                            </Select.Option>
                          </Select>
