...
class TurnBackFactoryPopup extends React.Component {
    ...
    handleFileUpload(event) {
        ...
        fileReader.onload = async function (event) {
            ...
            // }
            let resultSearch = await getInformationFromCylinders(cylinders_list, Constant.TURN_BACK_TYPE);
    ...
    render() {
        return (
            <div className="modal fade" id="turnback-modal" tabIndex="-1">
                            ...
                            <Form ref={c => {
                                ...
                                <footer className="card-footer text-center">
                                    <button className="btn btn-primary"
                                            ...
                                            onClick={() => {
                                                const modal = $("#turnback-modal");
                                                modal.modal('hide');
                                            }} type="submit" data-toggle="modal"
                                            data-target="#turn-back-driver">Tiếp Tục
                                    </button>
...
export default TurnBackFactoryPopup;
