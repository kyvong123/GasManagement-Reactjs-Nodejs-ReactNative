...
async function addProductAPI(serial, color, checkedDate, weight, placeStatus, status, classification/*currentImportPrice, cylinderType*/, manufacture, valve, manufacturedBy, cylinderAt_childFactory, category, productionDate,
    embossLetters) {
