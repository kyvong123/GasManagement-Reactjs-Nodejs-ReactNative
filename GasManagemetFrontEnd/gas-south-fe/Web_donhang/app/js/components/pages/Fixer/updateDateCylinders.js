...
class updateDateCylinders extends React.Component {
  ...
  async submitUpdateFile() {
    ...
    const result = await updateDateCylinderApi(
      arrDataID,
      data.checkedDateUpdate
    );
  ...
  handleFileUpload(event, isCheck) {
    ...
    if (isCheck) {
      ...
      fileReader.onload = async function(event) {
        ...
        let resultSearch = await getInformationFromCylindersExcel(
          cylinders_list,
          Constant.CHANGE_DATE
        );
  ...
  render() {
    return (
      <div
        ...
        id="update-cylinder-information"
        tabIndex="-1"
      >
                      ...
                      <div className="form-group">
                        ...
                        <div style={{ display: "flex" }}>
                          <input
                            ...
                            onChange={(event) =>
                              this.handleFileUploadExcel(event)
                            }
