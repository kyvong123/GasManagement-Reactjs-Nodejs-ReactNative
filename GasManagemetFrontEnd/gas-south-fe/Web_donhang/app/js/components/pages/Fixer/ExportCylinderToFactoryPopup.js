...
class ImportCylinderForFixer extends React.Component {
  ...
  render() {
    return (
      <div className="modal fade" id="export-from-fixer-to-factory" tabIndex="-1">
                ...
                <footer className="card-footer text-center">
                  <button
                    ...
                    className="btn btn-primary" onClick={(event) => {
                      ...
                      const modal = $("#export-from-fixer-to-factory");
                      modal.modal('hide');
                    }} type="submit" data-toggle="modal"
                    data-target="#export_fixer_popup">Tiếp Tục
                                    </button>
...
export default ImportCylinderForFixer;