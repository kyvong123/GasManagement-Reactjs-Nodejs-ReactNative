...
import PopupSearchImportOrder from "./popupSearchImportOrder";
...
class CreateImportOrderManage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      checkbox: false,
    ...
    await callApi("POST", CREATEEXPORTORDER, params, token).then((res) => {
      ...
      if (res.data.success === true) {
        openNotificationWithIcon(
          "success",
          <span> Tạo lệnh nhập thành công!</span>
        );
        window.location.href = "#/import-order-management";
      } else {
        if (
          (this.state.checkbox && nameDriver === "") ||
          (!this.state.checkbox && this.state.idDriver === "")
        ) {
          openNotificationWithIcon(
            "error",
            <span>
          ...
          openNotificationWithIcon(
            ...
            <span>
              {" "}
              Vui lòng nhập{" "}
              <b style={{ fontWeight: "bold" }}>TRỌNG LƯỢNG XE VÀO</b>
            </span>
          );
          ...
          openNotificationWithIcon(
            ...
            <span>
              {" "}
              Vui lòng nhập{" "}
              <b style={{ fontWeight: "bold" }}>TRỌNG LƯỢNG XE RA</b>
            </span>
          );
        ...
        //     errorLicense: "Vui lòng nhập biển số xe (*)",
        //     errorWareHouse: "Vui lòng chọn kho nhập (*)",
        //     errorUser: "Vui lòng chọn nơi nhận (*)",
        //     errorEmpty: "Vui lòng nhập trọng lượng rỗng (*)",
        //     errorFull: "Vui lòng nhập trọng lượng đầy (*)",
        //     errorDate: "Vui lòng chọn ngày giao (*)",
        //     errorOrder: "Vui lòng chọn đơn hàng (*)",
        //     errorNote: "Vui lòng nhập ghi chú (*)",
        //     errorTime: "Vui lòng chọn giờ giao (*)",
        //   });
      }
  ...
  handleKeySelectTion = (value) => {
    // value.map(v => {
    //     this.setState({
    //         idOrderTank: [...this.state.idOrderTank, v]
    //     }, () => console.log("idOrderTank", this.state.idOrderTank))
    // });
    this.setState({
      idOrderTank: value,
    });
  ...
  handleRowSelectTion = (value) => {
    // value.map(v => {
    //     this.setState({
    //         listOrderTank: [...this.state.listOrderTank, v]
    //     });
    // })
    ...
    this.setState({
      ...
      // wareHouseName: wareHouseName[0] ? wareHouseName[0].name : "Kho nhập không xác định!"
      _order,
    });
  };
  onClickDelOrder = (id) => {
  ...
  render() {
    ...
    return (
      <div className="main-content" id="CreateImportOrderManage">
        <div className="card">
          <Form onSubmit={(event) => this.onSubmitImportOrder(event)}>
            <div className="card-title">
              <div className="card-product">
                <div className="card-product-left mt-1">
                  <Link to="/import-order-management" className="p-1 bg-white">
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-12 mt-5">
                      <button
                        ...
                        data-toggle="modal"
                        data-target="#search-import-order"
            ...
            <div className="card-footer text-center">
              ...
              <Link to="/import-order-management" className="p-0">
...
export default CreateImportOrderManage;
