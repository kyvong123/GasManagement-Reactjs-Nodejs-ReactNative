...
class ExportWarehousePopup extends React.Component {
  constructor(props) {
    super(props);
    this.form = null;
    this.state = {
  ...
  render() {
    return (
      <div className="modal fade" id="export-modal-warehouse" tabIndex="-1">
          ...
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                Xuất Bình - Bước 1 - Nhập File Kho xe
              </h5>
                      ...
                      <Tabs>
                        ...
                        >
                          <Button
                            ...
                            size="large"
                            onClick={this.handleSuccessDownload}
                          >
                            Download
                          </Button>
                          <table
                            className="table table-striped table-bordered seednet-table-keep-column-width mt-1"
                            cellSpacing="0"
                          >
                ...
                <footer className="card-footer text-center">
                  <button
                    ...
                    onClick={(event) => {
                      ...
                      this.handleContinue();
                      const modal = $("#export-modal-warehouse");
                    ...
                    data-target="#export-driver-warehouse"
                  >
                    Tiếp Tục
                  </button>
                  <button
...
export default ExportWarehousePopup;
