...
class ExportBackFactoryPopup extends React.Component {
  constructor(props) {
    super(props);
    this.form = null;
    this.state = {
  ...
  handleFileUpload(event) {
    ...
    fileReader.onload = async function(event) {
      ...
      console.log("Constant.EXPORT_TYPE", Constant.EXPORT_TYPE);
      if (cylinders_list.length === 0) {
        ...
        if (resultSearch.status === 200) {
          ...
          showToast("Láy dữ liệu thành công", 3000);
          that.setState({
            loading: false,
  ...
  render() {
    return (
      <div className="modal fade" id="export-modal-back-factory" tabIndex="-1">
        <ReactCustomLoading isLoading={this.state.loading} />
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title">
                Xuất Bình Về Thương Nhân Sở Hữu - Bước 1 - Nhập File
              </h5>
              ...
              >
                ...
                <footer className="card-footer text-center">
                  <button
                    ...
                    onClick={() => {
                      const modal = $("#export-modal-back-factory");
                      modal.modal("hide");
                    }}
                    type="submit"
                    data-toggle="modal"
                    data-target="#export-driver-back-factory"
                  >
                    Tiếp Tục
                  </button>
                  <button
...
export default ExportBackFactoryPopup;
