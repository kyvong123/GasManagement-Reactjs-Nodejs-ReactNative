...
async function createHistoryAPI(driver, license_plate, cylinders, type, to_id, import_type, numberOfCylinder, from_id, to_array, number_array, phoneCustomer = '', nameCustomer = '', addressCustomer = '', typeForPartner, exportPlace, idDriver, sign, cylinderImex, idImex, typeImex, flow, cylinerIneligible, turnBack_cylinerIneligible, shipper='',phoneNumber='',) {
    let data;
    try{
