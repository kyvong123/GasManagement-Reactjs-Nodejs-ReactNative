...
import { EXPORTCYLINDERDUPLICATE } from 'config';
import getUserCookies from "getUserCookies";
import Constant from "Constants";
import showToast from "showToast";
async function exportCylinderDuplicate(driver, license_plate, cylinders, type, to_id, import_type, numberOfCylinder, from_id, to_array, number_array, phoneCustomer = '', nameCustomer = '', addressCustomer = '', typeForPartner, exportPlace, idDriver, sign, cylinderImex, idImex, typeImex, flow, successCylinders, cylinerIneligible) {
    let data;
    try {
    ...
    if (user_cookies) {
        ...
        switch (type) {
            case Constant.EXPORT_BACK_FACTORY:
                params = {
                    ...
                    "notDupAndCantExport": cylinerIneligible
                };
                break;
        ...
        await axios.post(
            EXPORTCYLINDERDUPLICATE, params, {
            headers: {
...
export default exportCylinderDuplicate;
