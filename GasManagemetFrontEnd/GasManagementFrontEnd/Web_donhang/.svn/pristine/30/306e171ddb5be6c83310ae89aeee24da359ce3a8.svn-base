            ...
            if (res.data.message === "user không tồn tại!") {
              ...
              if (
                ...
                openNotificationWithIcon(
                  ...
                  <div>
                    <span>
                      Khối lượng còn lại được xuất cho đơn hàng này là{" "}
                    </span>
                    <b style={{ fontWeight: "bold" }}>{res.data.weight}</b>
                    <span> tấn.</span>
                    <div>
                      <span>(Đơn hàng này đã tồn tại 1 lệnh xuất!)</span>
                    </div>
                  </div>
                );
              } else {
          ...
          if (
            ...
            if (Number(res.data.weight) == 0) {
              ...
              openNotificationWithIcon(
                "error",
                <div>
                  <span>Khối lượng tối đa được xuất cho đơn hàng này là </span>
                  <b style={{ fontWeight: "bold" }}>{res.data.weight}</b>{" "}
                  <span> tấn.</span>
                  <div>
                    <span>
                      Cập nhật lại thông tin lệnh xuất trước khi thay đổi đơn
                      hàng!
                    </span>
                  </div>
                </div>
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header table__head rounded-0">
              <h4 className="modal-title text-white">Chỉnh sửa lệnh xuất</h4>
