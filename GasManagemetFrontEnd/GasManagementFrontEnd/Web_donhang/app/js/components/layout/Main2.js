...
import PopupComponent from "../pages/dashBoard/PopupComponent";
class Main2 extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      statisticVer2_toggle: false,
      thongKeTramXuong: false,
      isShowMenu: [
        true,
        true,
        true,
  ...
  detectMenu() {
    const menu = {
      ...
      "/orderManagement": 60,
      "/error-statistics": 63,
      "/price-gas-management": 62,
      "/price-cylinders-management": 64,
      "/create-new-order": 65,
      "/vehicle-inventory": 66,
      "/warehouse": 67,
    };
  ...
  async componentDidMount() {
    ...
    // console.log("NAME", this.state.user.user);
  ...
  async getUser() {
    ...
    if (typeof user !== "undefined") {
      ...
      if (
        ...
        (this.state.user.user.userType === Constant.FACTORY ||
          this.state.user.user.userType === "Personnel") &&
        this.state.user.user.userRole !== "Deliver" &&
        this.state.user.user.userRole !== "Inspector"
      ) {
  ...
  render() {
    ...
    return (
      <div>
            ...
            <ul className="menu">
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span className="title">Khách Hàng Công Nghiệp Bình</span>
                  </Link>
                </li>
                ...
                >
                  ...
                  >
                    <i className="fa fa-users" aria-hidden="true"></i>
                    <span className="title">Tổng Đại Lý</span>
                  </Link>
                </li>
              ...
              {this.state.userType === "Personnel" &&
                this.state.userRole === "SuperAdmin" && (
                  ...
                  >
                    <Link
                      onClick={() => this.setState({ isMenuIndex: 61 })}
              ...
              <li
                data-toggle="collapse"
                data-target="#tramxuong"
                style={!this.state.isStatistical ? { display: "none" } : {}}
                className={`collapsed menu-item ${
                  this.state.isMenuIndex == "thongKeV2"
                    ? "menu-item active1"
                    : "menu-item"
                }`}
              >
                <Link
                  onClick={() => {
                    console.log(
                      "nhấn vào thống kê V2",
                      this.state.statisticVer2_toggle
                    );
                    this.setState({
                      statisticVer2_toggle: !this.state.statisticVer2_toggle,
                    });
                    this.setState({
                      currentMenu: "thongKeV2",
                      isMenuIndex: "thongKeV2",
                    });
                  }}
                  className="menu-link"
                >
                  <i className="fa fa-bar-chart" aria-hidden="true"></i>
                  <span>Báo cáo thống kê V2</span>
                  <i
                    className={
                      this.state.statisticVer2_toggle &&
                      this.state.currentMenu == "thongKeV2"
                        ? "fa fa-minus"
                        : "fa fa-plus"
                    }
                  ></i>
              ...
              >
                <li
                  className={
                    this.state.isMenuIndex == "thongKeTramXuong"
                      ? "menu-item active1"
                      : "menu-item"
                  }
                >
                  <Link
                    ...
                    onClick={() => {
                      this.setState({
                        isMenuIndex: "thongKeTramXuong",
                      });
                    }}
                    className="menu-link "
                  >
                    <i className="fa fa-industry" aria-hidden="true"></i>
                    <span className="title">Thống kê trạm, nhà xưởng</span>
                  </Link>
                </li>
                <li
                  className={
                    this.state.isMenuIndex == "thongKeKhoXe"
                      ? "menu-item active1"
                      : "menu-item"
                  }
                >
                  <Link
                    ...
                    onClick={() => {
                      this.setState({
                        isMenuIndex: "thongKeKhoXe",
                      });
                    }}
                    className="menu-link "
                  >
                    <i className="fa fa-robot" aria-hidden="true"></i>
                    <span className="title">Thống kê kho xe</span>
                  </Link>
                </li>
              </div>
              ...
              <li
                style={!this.state.isStatistical ? { display: "none" } : {}}
                className={
                  this.state.isMenuIndex === 49
                    ? "menu-item active"
                    : "menu-item"
                }
              >
                <Link
                  onClick={() => this.active(49)}
                  to="/shell-statistics"
                  className="menu-link"
                >
                  <i className="fa fa-bar-chart" aria-hidden="true"></i>
                  <span className="title">Thống kê xuất vỏ/ Thanh lý</span>
                </Link>
              </li>
              ...
              >
                ...
                >
                  <i className="fa fa-cart-plus" aria-hidden="true"></i>
                  <span className="title">Đại lý</span>
                </Link>
              </li>
              ...
              {this.state.userType === "Factory" &&
                this.state.userRole === "SuperAdmin" && (
                  ...
                  >
                    ...
                    >
                      <i className="fa fa-user" aria-hidden="true"></i>
                      <span className="title">Quản lý nhân sự</span>
                    </Link>
                  </li>
                )}
              {/* {!(
              ...
              this.state.userType === "Fixer" ? (
                ...
                >
                  ...
                  >
                    <i className="fa fa-bar-chart" aria-hidden="true"></i>
                    <span className="title">Thống kê nhập vỏ/ thanh lý</span>
                  </Link>
                </li>
              ) : (
                ""
              ...
              {!(
                ...
                (this.state.userType === "Tong_cong_ty" ||
                this.state.userType === "Tram" ? (
                  <li
              ...
              {/* <li
                data-toggle="collapse"
                data-target="#orders"
                className={`collapsed menu-item ${this.state.isMenuIndex === 61
                  ? "menu-item active"
                  : "menu-item"
                  }`}
              >
                <Link
                  className="menu-link"
                  onClick={() => this.active(61)}
                  to="/order-statistics"
                >
                  <Icon type="table" className="fa" />
                  <span className="title">Thống kê giao hàng</span>
                </Link>
              </li> */}
              ...
              {this.state.userRole === "Truong_phongKD" ||
              this.state.userRole == "Pho_giam_docKD" ||
              this.state.userRole === "Truong_tram" ? (
                <li
                  // data-toggle="collapse"
                  // data-target="#orders"
                  className={`collapsed menu-item ${
                ...
                >
                  <Link
                    className="menu-link"
                    onClick={() => this.active(63)}
                    to="/error-statistics"
                  >
                    <Icon type="table" className="fa" />
                    <span className="title">Thống Kê Bình Lỗi</span>
                  </Link>
                </li>
              ) : (
                ""
              ...
              {/* <li
                data-toggle="collapse"
                data-target="#orders"
                className={`collapsed menu-item ${this.state.isMenuIndex === 60
                  ? "menu-item active"
                  : "menu-item"
                  }`}
              >
                ...
                >
                  ...
                  <div className="order-unread-count">
                    <div id="value-unseen">0</div>
                  </div>
                </Link>
              </li> */}
              {this.state.userRole === "To_nhan_lenh" ||
              this.state.userType === "General" ||
              this.state.userType === "Agency" ||
              (this.state.userType === "Tong_cong_ty" &&
                this.state.userRole === "phongKD") ? (
                <li
                  // data-toggle="collapse"
                  // data-target="#orders"
                  className={`collapsed menu-item ${
                    this.state.isMenuIndex === 65
                      ? "menu-item active"
                      : "menu-item"
                  }`}
                >
                  <Link
                    className="menu-link"
                    onClick={() => this.active(65)}
                    to="/create-new-order"
                  >
                    <Icon type="edit" className="fa" />
              ...
              this.state.userRole === "phongKD" ? (
                ...
                >
                  <Link
                    className="menu-link"
                    onClick={() => this.active(62)}
                    to="/price-gas-management"
                  >
                    <GiPriceTag />
                    {/* <Icon type="global" className="fa" /> */}
                    <span className="title">Giá Gas</span>
                  </Link>
                </li>
              ) : (
                ""
              ...
              this.state.userRole === "phongKD" ? (
                ...
                >
                  <Link
                    className="menu-link"
                    onClick={() => this.active(64)}
                    to="/price-cylinders-management"
                  >
                    <GiPriceTag />
                    {/* <Icon type="global" className="fa" /> */}
                    <span className="title">Giá vỏ</span>
                  </Link>
                </li>
              ) : (
                ""
              ...
              >
                {this.state.userRole === "SuperAdmin" &&
                  (this.state.userType === "Factory" ||
                    ...
                    <li
                      style={
                        !this.state.isShowWarehouse ? { display: "none" } : {}
                      }
                      className={
                        this.state.isMenuIndex === 15
                          ? "menu-item active"
                    ...
                    >
                      ...
                      >
                        <Icon type="robot" className="fa" />
                        <span className="title">Kho xe</span>
                      </Link>
                    </li>
                  )}
                <a
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <ul className="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
                ...
                <li className="nav-item">
                  <Link to="/cac-cau-hoi-thuong-gap">Hỏi đáp</Link>
                </li>
                <li className="nav-item">
        ...
        <PopupLogOut />
        <PopupComponent routerUrl={"/login"} />
        {/*  <Pricing/>
