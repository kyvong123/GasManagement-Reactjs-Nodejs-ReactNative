...
class ExportEmptyFactorySelection extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  xuatkhoxe = () => {
    ...
    $("#export-empty-modal-selection").modal("hide");
  };
  xuatthangkhachhang = () => {
    ...
    return (
      <Fragment>
        <div
          ...
          id="export-empty-modal-selection"
          tabIndex="-1"
        >
...
export default ExportEmptyFactorySelection;
