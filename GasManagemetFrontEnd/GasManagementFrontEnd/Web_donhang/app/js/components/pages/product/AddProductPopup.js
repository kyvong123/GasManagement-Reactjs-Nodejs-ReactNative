                ...
                <div className="card-body">
                  <div className="row">
                            ...
                            >
                              ...
                              >
                                {this.state.user_type === "Factory"
                                  ...
                                  : "Vị trí hiện tại: Tại Hệ Thống Đại lý"}
                              </label>
                            </Radio>
                            <Radio
                              style={radioStyle}
                    ...
                    <div className="col-md-6">
                      ...
                      {/* <label>{this.state.user_type === "Factory" ? "Vị trí hiện tại: Tại thương nhân sở hữu" : "Vị trí hiện tại: Tại đại lý"} </label> */}
                      ...
                      {/* <label>{this.state.user_type === "Factory" ? "Vị trí hiện tại: Tại thương nhân sở hữu" : "Vị trí hiện tại: Tại Hệ Thống Đại lý"} </label> */}
                    </div>
