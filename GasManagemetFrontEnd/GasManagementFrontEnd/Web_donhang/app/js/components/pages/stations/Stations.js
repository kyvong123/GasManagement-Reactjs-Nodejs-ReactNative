              ...
              <div className="modal-header">
                <h5 className="modal-title">
                  ...
                  {this.props.isCreateMode
                    ? (this.props.isFactoryPage ? "Tạo Mới Thương Nhân Sở Hữu" : this.props.isGeneralPage ? "Tạo Mới Trạm" : this.props.isAgencyPage ? "Tạo Mới Hệ Thống Đại lý" : this.props.isFactoryChildPage ? "Tạo Mới Công ty - Chi nhánh trực thuộc" : this.props.isFixerPage ? "Tạo Mới Nhà Máy Sửa Chữa" : "")
                    : (this.props.isFactoryPage ? "Chỉnh Sửa Thông Tin Thương Nhân Sở Hữu" : this.props.isGeneralPage ? "Chỉnh Sửa Thông Tin Tổng đại lý" : this.props.isAgencyPage ? "Chỉnh Sửa Thông Tin Hệ Thống Đại lý" : this.props.isFactoryChildPage ? "Chỉnh Sửa Thông Tin Công ty - Chi nhánh trực thuộc" : this.props.isFixerPage ? "Chỉnh Sửa Thông Tin Nhà Máy Sửa Chữa" : "")}
                </h5>
