...
import { deliveryStoreSerialAction } from '../../actions/DeliveryActions';
import { SHIPPING_TYPE } from '../../constants';
import { element } from 'prop-types';

const DriverDeliveryProductInfo = (props) => {
                    ...
                    {productInfor ?
                        <>
                            ...
                            <View style={tw('items-center my-12')}>
                                <Button width="45%"
                                    onPress={() => Actions['driverDeliveryScan']({})}
                                    colorScheme="orange">
                                    Tiếp tục quét
                                </Button>
                                <Button style={[tw('mt-4'), { marginBottom: 200 }]} width="45%" onPress={() => { Actions['driverDeliveryListSerial']({}) }} colorScheme="green">
                                    Kết thúc quét
                                </Button>
                            </View>
                        </>
...
export default DriverDeliveryProductInfo
