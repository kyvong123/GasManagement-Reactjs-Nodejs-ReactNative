...
import { driverResetListSerialOrder } from '../../actions/DeliveryActions';
...
const DriverDeliverySubmit = (props) => {
    ...
    const currentOrderSelection = useSelector(state => state.deliveryReducer.currentOrderSelection);
        ...
        const postToServer = async () => {
            try {
                ...
                const body = {
                    ...
                    driver: form.driver ? form.driver : null,
                    driverName: form.driverName,
                    transport: form.licensePlate,
                    shippingType: currentTypeDelivery,
                    userid: form.driver ? form.driver : null,
                ...
                if (res.success) {
                    ...
                    dispatch(driverResetListSerialOrder());
                    Alert.alert(
                    ...
                    <View style={[tw(), { paddingHorizontal: 30, marginTop: 20 }]}>
                        <View>
                            <Radio.Group
                                ...
                                onChange={value => {
                                    ...
                                    setForm({
                                        ...form,
                                        driverName: value === DRIVER_TYPE.EXTERNAL_DRIVER ? '' : userInfo.name
                                    })
                                    setTypeName(value);
                                }}>
                                ...
                                <Radio value={DRIVER_TYPE.EXTERNAL_DRIVER} my={1}>
                                    <Text>Tài xế ngoài</Text>
                                </Radio>
                            </Radio.Group>
                            {typeName === DRIVER_TYPE.INTERNAL_DRIVER ?
                                <Input isDisabled value={form.driverName} />
                                :
                                <Input
                                    onChangeText={value => {
                                        setForm({
                            ...
                            {errInput.driverName ?
                                <Text style={[{ color: 'red' }]}>Hãy nhập tên tài xế ngoài</Text>
                                : null
                            }
                        </View>
                        <View style={{ marginTop: 20 }}>
                            ...
                            {errInput.licensePlate ?
                                <Text style={[{ color: 'red' }]}>Hãy nhập biển số xe</Text>
                                : null
                            }
                        </View>
...
export default DriverDeliverySubmit;
