...
ArticleSearch.propTypes = propTypes;
// const getSelectedService = (services, servicesIds) =>{
//     const selectedServices = services.reduce((prev, curr) => {
...
export default connect(mapStateToProps, {queryChanged,fetchArticles, toggleExpandArticle, resetQuery, cleanArticles, fetchArticle, fetchArticleTypes, fetchArticleServices})(withNetInfo(ArticleSearch));