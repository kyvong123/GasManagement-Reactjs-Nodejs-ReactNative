...
class TruckDeliveryScan extends Component {
    state = {
        loading: false,
        uri: "",
        path: "",
            ...
            Alert.alert(
                ...
                [
                    ...
                    },
                    {
                        ...
                        onPress: () => {
                            this.setState({ checkScreen: true }, () => Actions['truckDeliveryScanManual']({}));
                        },
                    },
                ],
                { cancelable: false }
...
export default connect(mapStateToProps, { fetchCylinder })(withNetInfo(TruckDeliveryScan));
