...
class DriverDeliveryScan extends Component {
    state = {
        loading: false,
        uri: "",
        path: "",
    ...
    showResult = async (results) => {
        if (
            ...
            Alert.alert(
                ...
                [
                    ...
                    },
                    {
                        ...
                        onPress: () => {
                            this.setState({ checkScreen: true }, () => Actions['driverDeliveryScanManual']({}));
                        },
                    },
                ],
                { cancelable: false }
            ...
            Actions.push("driverDeliveryProductInfo", { serial: serialList, titleScreen: this.props.titleScreen });
...
export default connect(mapStateToProps, { fetchCylinder })(withNetInfo(DriverDeliveryScan));
