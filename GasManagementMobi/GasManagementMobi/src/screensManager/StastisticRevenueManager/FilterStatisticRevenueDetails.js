...
import { Picker, Text, View, StyleSheet, SafeAreaView, TouchableOpacity, ActivityIndicator, ScrollView } from 'react-native';
...
import { AGENCY, FACTORY, GENERAL, KHACH_HANG, TRAM } from '../../types';
...
export default function FilterStatisticRevenueDetails() {
        ...
        <SafeAreaView style={styles.container}>
            <View style={styles.Nav_container}>
                <TouchableOpacity
                    ...
                    onPress={() => Actions['statisticRevenueDetails']({})}
                >
