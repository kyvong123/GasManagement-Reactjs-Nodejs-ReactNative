		...
		this.setState({ submitted: true }, () => {
			if (serial) {
				...
				this.setState({ serial: '', submitted: false }, () =>
					//this.props.fetchCylinder([updatedSerial],2),
							...
							<WingBlank>
								...
								{isLoading ? (
									...
									<View style={{ alignItems: 'center' }}>
										...
										{/*  onHideUnderlay={this.handleSubmit}*/}
										{/*>*/}
										{/*  Tra cứu*/}
										{/*</Button>*/}
										<WhiteSpace />
										<TouchableOpacity style={styles.btn} onPress={Actions.scan}>
											<Text style={styles.txtButton}>
												{translate('RESCAN')}
											</Text>
										</TouchableOpacity>
...
export default connect(mapStateToProps, { fetchCylinder })(ScanManual);
