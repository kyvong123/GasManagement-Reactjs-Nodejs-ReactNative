...
class DriverDeliveryScanManual extends Component {
    constructor(props) {
        super(props);
        this.state = {
            serial: '',
        ...
        this.setState({ submitted: true }, () => {
            if (serial) {
                ...
                this.setState({ serial: '', submitted: false }, () =>
                    Actions.push('driverDeliveryProductInfo', {
...
export default connect(mapStateToProps, { fetchCylinder })(DriverDeliveryScanManual);
